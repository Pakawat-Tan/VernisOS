...
; 0x7C7B          | ...   | `no_cpuid:`             | CPU old                  | ถ้าไม่รองรับ CPUID  → แสดงข้อความ และหยุดการทำงาน                                                  |
...
load_stage2:
    ...
    mov al, 0x05            ; จำนวน sectors (5, expanded for VBE code)
...
; Data
; =====================================================
cpu_mode db 0               ; 0=old, 1=x86, 2=x86_64
...
msg_no_cpuid        db 'CPU detected (CPUID not supported)', 13, 10, 0
