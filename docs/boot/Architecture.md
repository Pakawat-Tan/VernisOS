## การตรวจจับสถาปัตยกรรม CPU และลำดับการบูต (ระบบ Stage)
...
├────────────────────────────────────────────────────────────────────────────────────────┤
 ...
 - โหลด kernel โดยใช้ BIOS LBA หรือ fallback เป็น CHS                                  
   ├── [LBA Available] → โหลด kernel_x64 จาก sector 2048 (12 chunks x 128 sectors = 1536 sectors)                        
